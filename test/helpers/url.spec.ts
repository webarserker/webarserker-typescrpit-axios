...
import { isURLSearchParams } from '../../src/helpers/util';
...
describe(' helpers:url', () => {
  describe('buildURL', () => {
    ...
    test('should correct discord url hash mark', () => {
      expect(
    ...
    test('should use serializer if praoyided', () => {
  ...
  describe('isAbsoluteURL', () => {
    test('should return true is URL begins with valid scheme name', () => {
    ...
    test('should return true of URL is protocal-relative', () => {
      expect(isAbsoluteURL('//example.com/')).toBeTruthy();
    });

    test('should return  false if URL is relativ', () => {
